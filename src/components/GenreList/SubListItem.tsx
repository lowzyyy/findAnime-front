  ...
  return (
    <li className="flex items-center  md:gap-2">
      <a
        ...
        className=" cursor-pointer rounded-md p-1 text-blue-600 hover:bg-gradient-to-tr hover:to-indigo-500 xl:text-sky-700 xl:hover:from-indigo-400  xl:hover:text-white"
      >
